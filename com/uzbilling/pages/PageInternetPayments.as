package com.uzbilling.pages {
	...
	public class PageInternetPayments extends PageSliding {
		...
		public function PageInternetPayments() {
			// constructor code
			super.thisPageName = "internet_payments";
		}
...
//			tscroll.y = top.height + 30;
			...
			top.setTitle(ls.getData("mn1.tf3"));
...
//				dtHolder.alpha = 0;
		...
		override protected function onDataLoaded():void {
			trace("PageInternetPayments.dataLoaded!");
...
//						updData = true;
		...
		override protected function setData(dx:int):void {
			...
			for(var i:int=0;i<trafficArr.length;++i) {
				var tm:IPaymentsModel = trafficArr[i] as IPaymentsModel;
				//tm.setObject(trafficArr[]);
				
				var trafficCell:InfoCellPayments = new InfoCellPayments();
